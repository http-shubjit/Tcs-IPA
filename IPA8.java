...
import java.util.Scanner;
 ...
 class Solution {
    ...
    String c = sc.nextLine(); 
            sims[i] = new IPA8(id, cn, b, rps, c);
        }
        String cir1 = sc.next();
        sc.nextLine();
        String cir2 = sc.next();

        IPA8[] sim = transferCustomerCircle(sims, cir1, cir2);
for (int i = 0; i < sim.length; i++) {
    ...
    private static IPA8[] transferCustomerCircle(IPA8[] sims, String cir1, String cir2) {

        IPA8[] retarr = new IPA8[4];
        int c = 0;
        for (int i = 0; i < sims.length; i++) {
...
public class IPA8 {
    ...
    // Constructor
    public IPA8(int id, String cn, double b, double rps, String c) {
        this.id = id;
        this.cn = cn;
        this.b = b;
        this.rps = rps;
